...
export function useGenericImageCardForm(storageKey , redirectPath){
    ...
    const [cardImg, setCardImg] = useState(cardToEdit ? cardToEdit.cardImg : '');
    ...
    const mySubmit = (event)=>{
        ...
        const cardData = {cardImg , cardTitle , contentCard}
