...
export default function TextareaField({className , labelName , width , value , onChange ,required = true}) {
    return (
        <div className={`${className} rtThirdRow`} style={{width: width}}>
            ...
            <div>
                <textarea name="message" id="message" placeholder="Type here" value={value} required={required}
